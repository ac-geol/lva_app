# Background — the reasoning behind the current design

This is the README as it stood on 2026-09-14, kept verbatim when that file was
cut back to a short description. Nothing here has been edited, so the record of
what was tried and why is intact. Some of it is also covered, in more depth, in
`METHOD_COMPARISON.md`, `COMPOSITING.md` and `TODO.md`.
